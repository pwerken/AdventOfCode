...
> parseInput = lines
>
> lengthNoEscapes ('\\':'\\':xs)    = 1 + lengthNoEscapes xs
> lengthNoEscapes ('\\':'\"':xs)    = 1 + lengthNoEscapes xs
> lengthNoEscapes ('\\':'x':_:_:xs) = 1 + lengthNoEscapes xs
> lengthNoEscapes (_:xs)            = 1 + lengthNoEscapes xs
> lengthNoEscapes []                = -2
>
> length2 w = length w - lengthNoEscapes w
>
> day08 = solve "input-day08.txt" (sum . map length2 . parseInput)
...
> lengthNewEscape ('"':xs)  = 2 + lengthNewEscape xs
> lengthNewEscape ('\\':xs) = 2 + lengthNewEscape xs
> lengthNewEscape (_:xs)    = 1 + lengthNewEscape xs
> lengthNewEscape []        = 2
>
> length3 w = lengthNewEscape w - length w
>
> day08p2 = solve "input-day08.txt" (sum . map length3 . parseInput)
