...
>
> moveSub :: Pos -> Cmd -> Pos
> moveSub (x, y) (Forward z) = (x + z, y)
> moveSub (x, y) (Down    z) = (x, y + z)
> moveSub (x, y) (Up      z) = (x, y - z)
>
> day02 = solve "02" (uncurry (*) . foldl moveSub (0, 0) . parse)
...
>
> type Heading = (Int, Int, Int)
>
> headingSub :: Heading -> Cmd -> Heading
> headingSub (h, x, y) (Forward z) = (h    , x + z, y + z * h)
> headingSub (h, x, y) (Down    z) = (h + z, x    , y)
> headingSub (h, x, y) (Up      z) = (h - z, x    , y)
>
> result :: Heading -> Int
> result (_, x, y) = x * y
>
> day02p2 = solve "02" (result . foldl headingSub (0, 0, 0) . parse)
