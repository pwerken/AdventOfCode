...
>
> massToFuel :: Int -> Int
> massToFuel = (max 0) . flip (-) 2 . flip div 3
>
> day01 = solve "01" (sum . map massToFuel . parse)
...
>
> fuel4fuel :: Int -> Int
> fuel4fuel = sum . takeWhile (> 0) . drop 1 . iterate massToFuel
>
> day01p2 = solve "01" (sum . map fuel4fuel . parse)
