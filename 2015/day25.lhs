...
> parseInput = (\[x,_,y] -> (read $ init x, read $ init y)) . drop 15 . words
>
> toNr (r, c)   = ((+) (1 - r)) . head . drop (c + r - 2) . scanl1 (+) $ [1..]
>
> forceEval 1 x = x
> forceEval y x = forceEval (y-1) $! ((x * 252533) `mod` 33554393)
>
> day25 = solve "input-day25.txt" (flip forceEval 20151125 . toNr . parseInput)
