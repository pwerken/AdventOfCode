...
> import Data.List
>
> parseLine [_,_,c,_,d,_,f,_,t,_,a] = map read [c,d,f,t,a]::[Int]
> parseInput = map (parseLine . words . filter (/= ',')) . lines
>
> recepies =  [ [a,b,c,d,1]
...
>
> mult :: [[Int]] -> [Int] -> [Int]
> mult is xs = map (max 0 . sum . zipWith (*) xs) (transpose is)
>
> bestRecepy = maximum . flip map recepies . score . map init
>   where
>     score :: [[Int]] -> [Int] -> Int
>     score x y = product . take 4 $ mult x y
>
> day15 = solve "input-day15.txt" (bestRecepy . parseInput)
...
> score500 :: [[Int]] -> [Int] -> Int
> score500 is xs = if sum cs == 500 then product vs else 0
>   where
>     (vs, cs) = splitAt 4 $ mult is xs
>
> best500cal inp = maximum $ map (score500 inp) recepies
>
> day15p2 = solve "input-day15.txt" (best500cal . parseInput)
