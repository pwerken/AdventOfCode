...
Your puzze input is 367

>
> import Data.List (foldl')
>
> spinlock :: Int -> [Int] -> Int -> [Int]
> spinlock n xs y = (y:) . take (length xs) . drop (n + 1) . cycle $ xs
>
> day17 = head . tail $ foldl (spinlock 367) [0] [1..2017]
...
> positions i = iterate (step i) (1, 0)
>   where
>     step i (l, p) = (l + 1, 1 + (i + p) `mod` l)
>
> atPos1 :: [(Int, Int)] -> [Int]
> atPos1 = map (flip (-) 1 . fst) . filter ((==) 1 . snd)
>
> day17p2 = last . atPos1 . take 50000000 $ positions 367
