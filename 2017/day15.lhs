...
> parse = (\[x,y] -> (x,y)) . map (read . last . words) . lines
>
> generator :: Int -> Int -> [Int]
> generator x = map (dom 65536) . tail . iterate (dom 2147483647 . (*) x)
>
> genA = generator 16807
> genB = generator 48271
>
> judge :: Int -> ([Int], [Int]) -> Int
> judge n (as, bs) = length . filter id . take n $ zipWith (==) as bs
>
> day15 = solve "15" (judge 40000000 . mapSnd genB . mapFst genA . parse)
...
>
> dom0 :: Int -> [Int] -> [Int]
> dom0 x = filter ((==) 0 . dom x)
>
> genA' = dom0 4 . genA
> genB' = dom0 8 . genB
>
> day15p2 = solve "15" (judge 5000000 . mapSnd genB' . mapFst genA' . parse)
