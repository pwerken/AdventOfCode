...
> parse = map ((\[x, y] -> (x, y)) . map read . splitOn ':') . lines
>
> mod0 :: (Int, Int) -> Bool
> mod0 (l, r) = l `mod` (2 * r - 2) == 0
>
> calcSeverity :: [(Int, Int)] -> Int
> calcSeverity = sum . map (uncurry (*)) . filter mod0
>
> day13 = solve "13" (calcSeverity . parse)
...
> delay i = map (mapFst (+ i))
>
> tryDelays :: [(Int, Int)] -> [Int]
