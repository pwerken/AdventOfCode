...
> scoreGroups' i ('}':xs) = scoreGroups' (i - 1) xs
> scoreGroups' i (_:xs)   = scoreGroups' i xs
> scoreGroups' _ []       = 0
>
...
> countGarbage = fst . countGarbage' . (,) 0
>
> countGarbage' :: (Int, String) -> (Int, String)
> countGarbage' (i, ('<':xs))   = countGarbage'' (i, xs)
> countGarbage' (i, (_:xs))     = countGarbage' (i, xs)
> countGarbage' (i, [])         = (i, [])
>
> countGarbage'' :: (Int, String) -> (Int, String)
> countGarbage'' (i, ('>':xs))  = countGarbage' (i, xs)
