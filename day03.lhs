...
> movePos (x, y) 'v' = (x  , y+1)
>
> travelSanta :: [Char] -> [Pos]
> travelSanta = scanl movePos (0,0)
>
> houses = length . nub . sort
>
> day03 = solve "input-day03.txt" (houses . travelSanta)
...
> mergeTravels [] = []
> mergeTravels ((x,y):ps) = x:y:(mergeTravels ps)
>
> day03p2 = solve "input-day03.txt" (houses . travelBoth)
