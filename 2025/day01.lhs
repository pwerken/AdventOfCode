...
> turnDial p r = (p + r) `mod` 100
>
> doTurns :: [Int] -> [Int]
> doTurns = scanl turnDial 50
>
> countZeros :: [Int] -> Int
...
>
> singleClicks :: [Int] -> [Int]
> singleClicks = concatMap toSingle
>   where
>     toSingle :: Int -> [Int]
>     toSingle i
>       | i > 0     = replicate i 1
>       | otherwise = replicate (- i) (-1)
>
> day01p2 = solve "01" (countZeros . doTurns . singleClicks . parse)
