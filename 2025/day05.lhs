...
> parse = mapTuple (map parseRange) (map read) . split "" . splitOn '\n'
>   where
...
> isInRanges rs x = or . map (flip isInRange x) $ rs
>
> filterInRanges :: [Range] -> [Int] -> [Int]
> filterInRanges rs = filter (isInRanges rs)
>
> day05p1 = solve "05" (length . uncurry filterInRanges . parse)
>
> e = "3-5\n10-14\n16-20\n12-18\n\n1\n5\n8\n11\n17\n32\n"
...
>
> sortRs :: [Range] -> [Range]
> sortRs = sortBy (\(x, _) (y, _) -> compare x y)
>
> mergeRs :: [Range] -> [Range]
> mergeRs [r] = [r]
> mergeRs ((a,b):(x,y):cs)
>   | b < x     = (a,b) : mergeRs ((x,y):cs)
>   | otherwise = mergeRs ((min a x, max b y):cs)
>
> rangeSize :: Range -> Int
> rangeSize (x, y) = y - x + 1
>
> day05p2 = solve "05" (sum . map rangeSize . mergeRs . sortRs . fst . parse)
