...
>
> jolt12 :: String -> String
> jolt12 = head . filter ((==) 12 . length) . iterate dropStepUp
>
> dropStepUp :: String -> String
> dropStepUp [_] = []
> dropStepUp (a:b:cs)
>   | a < b = (b:cs)
>   | otherwise = a : dropStepUp (b:cs)
>
> day03p2 = solve "03" (sum . map (read . jolt12) . parse)
